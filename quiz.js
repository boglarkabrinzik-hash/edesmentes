...
function showResult() {
    ...
    const recommendedSweet = {
        csokis: { nev: "Csokoládé torta szelet", kep: "képek/csokitorta.jpg" },
        gyumolcsos: { nev: "Kézműves málna mousse", kep: "képek/malnamousse.png" },
        ropogos: { nev: "Mandulás keksz", kep: "képek/mandulas.jpg" },
        klasszikus: { nev: "Dobostorta (8 szeletes)", kep: "képek/dobostorta.jpg" }
    };
